    ...
    grunt.initConfig({
        ...
        concat : {
            components : {
                files : {
                    // Animator
                    'dist/components/animator/js/animator.js' : ['src/components/animator/js/wmscapabilities.js', 'src/components/animator/js/factory.js', 'src/components/animator/js/controller.js', 'src/components/animator/js/animator.js', 'src/components/animator/js/configloader.js'],
